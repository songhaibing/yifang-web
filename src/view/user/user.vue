    ...
    >
      <div class="sign-box" v-if="isShow">
        ...
        <div class="flex sign-date">
          <div class="flex2 one">+{{list[0].sign}}积分
            <div class="sign-num flexc" :class="{on:list[0].list== 1}">1</div>
          </div>
          <div class="flex2 two">+{{list[1].sign}}积分
            <div class="sign-num flexc" :class="{on:list[1].list== 1}">2</div>
          </div>
          <div class="flex2 three">+{{list[2].sign}}积分
            <div class="sign-num flexc" :class="{on:list[2].list== 1}">3</div>
          </div>
          <div class="flex2 fore">+{{list[3].sign}}积分
            <div class="sign-num flexc" :class="{on:list[3].list== 1}">4</div>
          </div>
        </div>
        <!-- 周五到周日 -->
        <div class="flex sign-data2">
          <div class="seven">+{{list[6].sign}}积分
            <div class="sign-num flexc" :class="{on:list[6].list== 1}">7</div>
          </div>
          <div class="six">+{{list[5].sign}}积分
            <div class="sign-num flexc" :class="{on:list[5].list== 1}">6</div>
          </div>
          <div class="five">+{{list[4].sign}}积分
            <div class="sign-num flexc" :class="{on:list[4].list== 1}">5</div>
          </div>
        </div>
